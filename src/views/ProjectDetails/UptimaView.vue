<template>
  <div>
    ...
    <section class="project-acheivement">
    ...
    <section class="reach-out">
        <div class="reach-out__container">
            <p>What does success look like for your project?</p>
            <a
...
<style src="./ProjectDetails.scss" lang="scss"></style>